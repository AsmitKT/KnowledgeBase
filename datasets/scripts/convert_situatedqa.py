...
def build_geo_rows(rows):
    ...
    return corpus, queries, test_qrels
...
def write_dataset(corpus_path, queries_path, test_qrels_path, corpus, queries, test_qrels):
...
def main() -> None:
    ...
    geo_corpus, geo_queries, geo_test = build_geo_rows(geo_rows)
    temp_corpus, temp_queries, temp_test = build_temp_rows(temp_rows)
    write_dataset(
